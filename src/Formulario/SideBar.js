            ...
            <Accordion style={{ padding: '0px' }}>
                  ...
                  <ul className="list-unstyled">
                    ...
                    <Accordion defaultActiveKey="4">
                      <Accordion.Item eventKey="4">
                        <Accordion.Header>Botella</Accordion.Header>
                        <Accordion.Body>
                          <ul className="list-unstyled">
                            <li>
                              <Link to="/ListaBotella" className="nav-link text-cyan">Botellas</Link>
                            </li>
                            <li>
                              <Link to="/ListaBotella2Nivel" className="nav-link text-cyan">Botellas2Nivel</Link>
                            </li>
                          </ul>
                        </Accordion.Body>
                      </Accordion.Item>
                    ...
                    {/* Submenu for Distribución */}
                    <Accordion defaultActiveKey="5">
                      <Accordion.Item eventKey="5">
                        <Accordion.Header>Distribución</Accordion.Header>
                        <Accordion.Body>
                          <ul className="list-unstyled">
                            <li>
                              <Link to="/ListaDistribucion" className="nav-link text-cyan">Distribuciones</Link>
                            </li>
                            <li>
                              <Link to="/ListaDistribucion2Nivel" className="nav-link text-cyan">Dist-2Nivel</Link>
                            </li>
                          </ul>
                        </Accordion.Body>
                      </Accordion.Item>
                    ...
                    <Accordion defaultActiveKey="6">
                      <Accordion.Item eventKey="6">
                        <Accordion.Header>NAP</Accordion.Header>
                        <Accordion.Body>
                          <ul className="list-unstyled">
                            <li>
                              <Link to="/ListaNap" className="nav-link text-cyan">NAPs</Link>
                            </li>
                            <li>
                              <Link to="/ListaNapDerivada" className="nav-link text-cyan">NAPs Derivadas</Link>
                            </li>
                          </ul>
                        </Accordion.Body>
                      </Accordion.Item>
                    ...
                    <li>
                      <Link to="/ListaIntervencion" className="nav-link text-cyan">Intervención</Link>
                    </li>
                    <li>
                      <Link to="/ListaSpliter" className="nav-link text-cyan">Spliter</Link>
                    </li>
                    <li>
                      <Link to="/ListaPtps" className="nav-link text-cyan">PTPs</Link>
                    </li>
                    <li>
              ...
              <Accordion.Item eventKey="2" style={{ marginBottom: '10px' }}>
                ...
                <Accordion.Body style={{ backgroundColor: 'white' }}>
                  <ul className="list-unstyled">
                    <li>
                      <Link to="/ListaIncidencias" className="nav-link text-cyan">Lista de Incidencias</Link>
                    </li>
                  </ul>
                </Accordion.Body>
              </Accordion.Item>
